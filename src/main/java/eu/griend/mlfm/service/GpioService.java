package eu.griend.mlfm.service;
...
public class GpioService {
	...
	public void getPlatformInfo() throws IOException, InterruptedException,
			ParseException {
		Platform platform = PlatformManager.getPlatform();
		System.out.println("Id: " + platform.getId());
		System.out.println("Label: " + platform.getLabel());
		...
		try {
			System.out.println("CPU Model Name    :  "
		...
		try {
			System.out.println("Hardware Revision :  "
